...
public class TiketService {
    ...
    public byte[] cetakTiket(PendaftaranMudik pendaftar) throws Exception {
        ...
        // (Ambil dari Rute, karena jadwal nempel di rute)
        ...
        // 🔥 REVISI: INFO BUS (AMBIL DARI KENDARAAN)
        // Cek dulu apakah admin sudah assign kendaraan ke penumpang ini?
        String busInfo = "Menunggu Plotting Admin";
        if (pendaftar.kendaraan != null) {
            // Ambil dari entity Kendaraan (nama_armada & plat_nomor)
            busInfo = pendaftar.kendaraan.nama_armada + " (" + pendaftar.kendaraan.plat_nomor + ")";
        }
